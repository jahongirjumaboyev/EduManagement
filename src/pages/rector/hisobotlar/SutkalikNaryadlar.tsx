...
interface Row {
  ...
  fish: string; xizmatJoyi: string; qabul: string; topshirish: string;
}

const MOCK: Row[] = [
  { id:1,  oquvYili:'2024-2025-y', kurs:'1-kurs', guruh:'125-guruh', fish:'Aliyev Alisher Baxtiyorovich',        xizmatJoyi:"1-NO'J bo'yicha navbatchi",                       qabul:'01.05.2025', topshirish:'02.05.2025' },
  { id:2,  oquvYili:'2024-2025-y', kurs:'2-kurs', guruh:'225-guruh', fish:'Karimov Jasur Saidovich',             xizmatJoyi:"1-NO'J bo'yicha navbatchi yordamchisi",           qabul:'02.05.2025', topshirish:'03.05.2025' },
  { id:3,  oquvYili:'2024-2025-y', kurs:'3-kurs', guruh:'325-guruh', fish:'Toshmatov Sardor Umarovich',          xizmatJoyi:"1-NO'J bo'yicha 1-posbon",                        qabul:'03.05.2025', topshirish:'04.05.2025' },
  { id:4,  oquvYili:'2024-2025-y', kurs:'4-kurs', guruh:'425-guruh', fish:'Yusupov Bobur Hamidovich',            xizmatJoyi:"2-NO'J bo'yicha navbatchi",                       qabul:'04.05.2025', topshirish:'05.05.2025' },
  { id:5,  oquvYili:'2024-2025-y', kurs:'1-kurs', guruh:'125-guruh', fish:'Raxmatullayev Nodir Ilhomovich',      xizmatJoyi:"O'quv bino bo'yicha navbatchi",                   qabul:'05.05.2025', topshirish:'06.05.2025' },
  { id:6,  oquvYili:'2024-2025-y', kurs:'2-kurs', guruh:'225-guruh', fish:'Nazarov Sherzod Abdullayevich',       xizmatJoyi:"1-yotoqxona bo'yicha navbatchi",                  qabul:'06.05.2025', topshirish:'07.05.2025' },
  { id:7,  oquvYili:'2024-2025-y', kurs:'3-kurs', guruh:'325-guruh', fish:'Mirzayev Ulugbek Utkurovich',         xizmatJoyi:"Institut bo'yicha 1-patrul",                      qabul:'07.05.2025', topshirish:'08.05.2025' },
  { id:8,  oquvYili:'2024-2025-y', kurs:'1-kurs', guruh:'125-guruh', fish:"Holmatov Firdavs Nematovich",         xizmatJoyi:"2-yotoqxona bo'yicha navbatchi",                  qabul:'08.05.2025', topshirish:'09.05.2025' },
  { id:9,  oquvYili:'2025-2026-y', kurs:'2-kurs', guruh:'225-guruh', fish:'Qodirov Dilshod Xurshidovich',        xizmatJoyi:"Institut bo'yicha 2-patrul",                      qabul:'09.05.2025', topshirish:'10.05.2025' },
  { id:10, oquvYili:'2025-2026-y', kurs:'4-kurs', guruh:'425-guruh', fish:'Ergashev Murod Baxromovich',          xizmatJoyi:"Qizlar yotoqxonasi bo'yicha navbatchi",           qabul:'10.05.2025', topshirish:'11.05.2025' },
  { id:11, oquvYili:'2025-2026-y', kurs:'1-kurs', guruh:'125-guruh', fish:'Xoliqov Sanjar Tursunovich',          xizmatJoyi:'Navbatchi yordamchisi',                           qabul:'11.05.2025', topshirish:'12.05.2025' },
  { id:12, oquvYili:'2025-2026-y', kurs:'3-kurs', guruh:'325-guruh', fish:'Yunusov Sirojiddin Abdulhamidovich',  xizmatJoyi:"1-NO'J bo'yicha 2-posbon",                        qabul:'12.05.2025', topshirish:'13.05.2025' },
  { id:13, oquvYili:'2025-2026-y', kurs:'2-kurs', guruh:'225-guruh', fish:'Umarov Laziz Ismoilovich',            xizmatJoyi:"2-NO'J bo'yicha posbon",                          qabul:'13.05.2025', topshirish:'14.05.2025' },
  { id:14, oquvYili:'2025-2026-y', kurs:'4-kurs', guruh:'425-guruh', fish:'Baxtiyorov Asilbek Ravshanbekovich',  xizmatJoyi:"O'quv bino bo'yicha navbatchi yordamchisi",       qabul:'14.05.2025', topshirish:'15.05.2025' },
  { id:15, oquvYili:'2024-2025-y', kurs:'1-kurs', guruh:'125-guruh', fish:'Rajabov Javlon Akbarovich',           xizmatJoyi:"Institut bo'yicha 3-patrul",                      qabul:'15.05.2025', topshirish:'16.05.2025' },
  { id:16, oquvYili:'2024-2025-y', kurs:'3-kurs', guruh:'325-guruh', fish:'Sobirov Kamol Mahmudovich',           xizmatJoyi:"1-yotoqxona bo'yicha posbon",                     qabul:'16.05.2025', topshirish:'17.05.2025' },
  { id:17, oquvYili:'2024-2025-y', kurs:'2-kurs', guruh:'225-guruh', fish:'Mansur Hulkar Alijonovich',           xizmatJoyi:"2-yotoqxona bo'yicha posbon",                     qabul:'17.05.2025', topshirish:'18.05.2025' },
  { id:18, oquvYili:'2025-2026-y', kurs:'4-kurs', guruh:'525-guruh', fish:'Ortiqov Sarvar Xurshidovich',         xizmatJoyi:"Qizlar yotoqxonasi bo'yicha posbon",              qabul:'18.05.2025', topshirish:'19.05.2025' },
  { id:19, oquvYili:'2025-2026-y', kurs:'1-kurs', guruh:'125-guruh', fish:'Norqoʻziyev Bekzod Ravshanbekovich', xizmatJoyi:"Institut bo'yicha 4-patrul",                      qabul:'19.05.2025', topshirish:'20.05.2025' },
  { id:20, oquvYili:'2024-2025-y', kurs:'2-kurs', guruh:'225-guruh', fish:"Isoqov Eldor Bahodir o'g'li",        xizmatJoyi:"1-yotoqxona bo'yicha navbatchi yordamchisi",      qabul:'20.05.2025', topshirish:'21.05.2025' },
  { id:21, oquvYili:'2024-2025-y', kurs:'3-kurs', guruh:'325-guruh', fish:'Tursunov Otabek Alijonovich',         xizmatJoyi:"2-NO'J bo'yicha navbatchi yordamchisi",           qabul:'21.05.2025', topshirish:'22.05.2025' },
  { id:22, oquvYili:'2025-2026-y', kurs:'4-kurs', guruh:'425-guruh', fish:'Hamidov Akbar Tohirovich',            xizmatJoyi:"2-yotoqxona bo'yicha navbatchi yordamchisi",      qabul:'22.05.2025', topshirish:'23.05.2025' },
  { id:23, oquvYili:'2025-2026-y', kurs:'1-kurs', guruh:'125-guruh', fish:'Razzaqov Zafar Rustamovich',          xizmatJoyi:"1-NO'J bo'yicha navbatchi",                       qabul:'23.05.2025', topshirish:'24.05.2025' },
  { id:24, oquvYili:'2024-2025-y', kurs:'2-kurs', guruh:'225-guruh', fish:'Abdullayev Farhodjon Sobirov',        xizmatJoyi:"O'quv bino bo'yicha navbatchi",                   qabul:'24.05.2025', topshirish:'25.05.2025' },
  { id:25, oquvYili:'2025-2026-y', kurs:'3-kurs', guruh:'325-guruh', fish:'Xasanov Mirzo Davronovich',           xizmatJoyi:"Institut bo'yicha 1-patrul",                      qabul:'25.05.2025', topshirish:'26.05.2025' },
];
...
const MENU_ITEMS: SidebarItem[] = [
  ...
  { icon: <UserOutlined />,     label: UZ.darsJadvali.profil,         path: '' },
  {
    ...
    subItems: [
      { label: H.sutkalikNaryadlar, path: '/kadr/hisobotlar/sutkalik-naryadlar', active: true },
...
export default function SutkalikNaryadlar() {
  ...
  const [fQabul, setFQabul] = useState<Dayjs | null>(null);
  const [fTopshirish, setFTopshirish] = useState<Dayjs | null>(null);
  ...
  const handleTopshirishChange = (val: Dayjs | null) => {
    setFTopshirish(val);
    if (fQabul && val && val.diff(fQabul, 'day') < 1) {
      setDateError(H.topshirishError);
    } else {
      setDateError('');
    }
  };

  const handleQabulChange = (val: Dayjs | null) => {
    setFQabul(val);
    if (fTopshirish && val && fTopshirish.diff(val, 'day') < 1) {
      setDateError(H.topshirishError);
    } else {
      setDateError('');
    }
  ...
  const filtered = MOCK.filter(r => {
    ...
    if (fJoy && r.xizmatJoyi !== fJoy) return false;
    ...
    <div className="min-h-screen bg-[#F8F9FA]">
      ...
      <div className="lg:ml-60 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6">
          ...
          <h2 className="text-base font-bold text-gray-800 mb-4">{H.subTitleSutkalik}</h2>
          ...
          <div className="bg-white rounded-xl border-t-4 border-[#3380FF] border border-gray-200 p-5">
            <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <select value={fJoy} onChange={e => { setFJoy(e.target.value); setPage(1); }}
                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 bg-white w-48 outline-none">
                  <option value="">— {H.xizmatOtashJoyi} —</option>
                  {H.xizmatJoyOptions.map(j => <option key={j} value={j}>{j}</option>)}
                </select>
                <div className="flex flex-col gap-1">
                  <DatePicker value={fQabul} onChange={handleQabulChange} format="DD.MM.YYYY" placeholder={H.qabulQilishSanasi} className="w-36" />
                </div>
                <div className="flex flex-col gap-1">
                  <DatePicker value={fTopshirish} onChange={handleTopshirishChange} format="DD.MM.YYYY" placeholder={H.topshirishSanasi} className="w-36" />
                </div>
              </div>
              <div className="flex items-center gap-3">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-[#F8F9FA] border-b border-gray-200">
                    ...
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">{H.xizmatOtashJoyi}</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">{H.qabulQilishSanasi}</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">{H.topshirishSanasi}</th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map((r, i) => (
                    <tr key={r.id} className={`border-b border-gray-100 hover:bg-blue-50 transition-colors ${i % 2 !== 0 ? 'bg-[#FAFBFC]' : ''}`}>
                      ...
                      <td className="px-4 py-3 text-gray-600">{r.xizmatJoyi}</td>
                      <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{r.qabul}</td>
                      <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{r.topshirish}</td>
                    </tr>
                  ))}
                  {rows.length === 0 && (
